(function () {
    ...
    function tabs (Alpine) {
        Alpine.directive('tabs', (el, directive) => {
            if      (! directive.value)                handleRoot$1(el, Alpine);
            ...
            else if (directive.value === 'panel')      handlePanel$1(el, Alpine);
        }).before('bind');
    ...
    function handlePanel$1(el, Alpine) {
        Alpine.bind(el, {
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
    ...
    // Alpine plugins.
    module_default.plugin([dialog, tabs, module_default$4, module_default$3, module_default$2, module_default$1]);
